...
class Canvas extends PureComponent {
    ...
    renderScene() {
        throttle(() => {
            ...
            if (this.controls.transformControl.mode === 'mirror' || !this.modelGroup.selectedModelArray.length || (this.modelGroup.selectedModelArray.length && some(this.modelGroup.selectedModelArray, { visible: false }))) {
